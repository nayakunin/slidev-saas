...
function createEnv(overrides: Partial<ExporterEnv> = {}): ExporterEnv {
  return {
    ...
    EXPORTS_BUCKET_ACCESS_KEY_ID: "access-key",
    EXPORTS_BUCKET_ENDPOINT: undefined,
    EXPORTS_BUCKET_FORCE_PATH_STYLE: false,
    EXPORTS_BUCKET_NAME: "exports",
    EXPORTS_BUCKET_REGION: "eu-central-1",
    EXPORTS_BUCKET_SECRET_ACCESS_KEY: "secret-key",
    HOST: "127.0.0.1",
    PORT: 3001,
    TMP_DIR: undefined,
    ...overrides,
